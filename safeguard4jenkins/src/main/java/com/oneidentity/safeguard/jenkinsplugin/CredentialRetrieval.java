...
import com.oneidentity.safeguard.jenkinsplugin.Messages;
...
public class CredentialRetrieval extends Builder implements SimpleBuildStep {
    ...
    public CredentialRetrieval(String safeguardAppliance, String certificatePath, String passPhrase, String apiKey) {
...
//    }
    ...
    public void perform(Run<?, ?> run, FilePath workspace, Launcher launcher, TaskListener listener) throws InterruptedException, IOException {
        ...
        try {
            ...
            listener.getLogger().println(Messages.CredentialRetrieval_DescriptorImpl_success_credentialRetrieval());
        } catch (Exception ex) {
            throw new InterruptedException(Messages.CredentialRetrieval_DescriptorImpl_errors_credentialRetrieval());
        }
    }
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public FormValidation doCheckSafeguardAppliance(@QueryParameter String value)
            ...
            if (value.length() == 0)
                return FormValidation.error(Messages.CredentialRetrieval_DescriptorImpl_errors_missingSafeguardAppliance());
        ...
        public FormValidation doCheckCertificatePath(@QueryParameter String value)
                throws IOException, ServletException {
            if (value.length() == 0)
                return FormValidation.error(Messages.CredentialRetrieval_DescriptorImpl_errors_missingCertificatePath());
            return FormValidation.ok();
        }
        ...
        public FormValidation doCheckPassPhrase(@QueryParameter String value)
                throws IOException, ServletException {
            if (value.length() == 0)
                return FormValidation.error(Messages.CredentialRetrieval_DescriptorImpl_errors_missingPassPhrase());
            return FormValidation.ok();
        }
        ...
        public FormValidation doCheckApiKey(@QueryParameter String value)
                throws IOException, ServletException {
            if (value.length() == 0)
                return FormValidation.error(Messages.CredentialRetrieval_DescriptorImpl_errors_missingApiKey());
            return FormValidation.ok();
        }
        ...
        public FormValidation doTestCredential(@QueryParameter("safeguardAppliance") final String sgAppliance, 
            ...
            try {
                ...
                return FormValidation.ok(Messages.CredentialRetrieval_DescriptorImpl_success_credentialRetrieval());
            } catch (Exception ex) {
                return FormValidation.error(Messages.CredentialRetrieval_DescriptorImpl_errors_credentialRetrieval() + ex.getMessage());
            }
        }
        ...
        public String getDisplayName() {
            return Messages.CredentialRetrieval_DescriptorImpl_DisplayName();
        }
